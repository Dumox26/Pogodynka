...
class WeatherClass {
  ...
  calculateWindSpeed() {
    const meterDivideBySecond = 3.6;
    return this.windSpeed * meterDivideBySecond;
  }
  ...
  static async downloadCurrentWeatherConditions(params) {
    ...
    return axios.get('https://api.openweathermap.org/data/2.5/weather?appid=92c581f751a8ab015bc220ef2217adf5&units=metric&lang=pl',
      { params });
  }
}
